...
//REEMPLAZADO (QUITAR EN CASO NO FUNCIONE)
...
app.post('/api/robot/send', async (req, res) => {
    ...
    try {
        // Usamos la función del archivo arduinoController.js que ahora devuelve un objeto
        const resultado = await enviarSecuenciaAlRobot(secuencia);
        
        // Desglosamos la respuesta para que React encuentre 'data.tiempo'
        res.json({ 
            exito: true, 
            estado: resultado.estado,
            tiempo: resultado.tiempo,
            mensaje: "Secuencia completada por el hardware" 
        });
